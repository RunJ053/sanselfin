...
<div class="main-content" style="margin-left:250px; padding:20px;">
  ...
  <!-- Gráfico -->
  <div class="chart-card mb-4 bg-white rounded shadow-sm p-3">
      ...
      <table class="table table-striped table-hover align-middle">
        ...
        <tbody>
          @foreach($productosRecientes as $producto)
            <tr>
              <td><img src="{{ asset($producto->imagen ? 'storage/' . $producto->imagen : 'img/product/default.png') }}" alt="img" width="45" height="45" style="object-fit:cover; border-radius:6px;"></td>
