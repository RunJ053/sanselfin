...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const notificationCheckboxes = document.querySelectorAll('.notiCheckbox');
        ...
        function updateSelectedCount() {
            const selectedCount = document.querySelectorAll('.notiCheckbox:checked').length;
            const totalCount = notificationCheckboxes.length;

            selectedCountSpan.textContent = `${selectedCount} seleccionadas`;
            deleteSelectedText.textContent = selectedCount === 1 ? 'Eliminar 1 notificación' : `Eliminar ${selectedCount} notificaciones`;

            // Mostrar/ocultar botón de eliminar seleccionadas
            if (selectedCount > 0) {
