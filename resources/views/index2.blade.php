    ...
    <nav class="main-nav" aria-label="Navegación principal">
        <div class="nav-left">
            <a href="{{ url('/Finca_Al_Dia2') }}" class="logo-link">
                <img src="{{ asset('img/logo/icon.png') }}" alt="Logo de La Finca al Día" width="150" height="50">
            </a>
        </div>
        ...
        <div class="nav-right">
            <ul class="nav-actions" role="menubar">
                ...
                <li role="none" class="relative inline-block text-left">
                    <div class="user-avatar" onclick="toggleDropdown()">
                        <i class="fas fa-user text-xl"></i>
                    </div>
                    <div class="dropdown-menu hidden absolute right-0 z-10 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg" id="dropdownMenu">
                        <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            <a href="{{ url('myProfile') }}" class="dropdown-item block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Ver Perfil</a>
                            <a href="{{ route('logout') }}" class="dropdown-item block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Cerrar Sesión</a>
                        </div>
                    </div>
                </li>
            </ul>
