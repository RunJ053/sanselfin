...
<main>
        ...
        <div class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <p>Puedes descubrir nuestra selección especial de productos que están marcando la diferencia este
                        mes.</p>
                </div>
                <div class="feature-item">
    ...
    <!-- Sección Testimonios -->
    <x-galeria-resenas :resenas="$resenas" />
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <div class="accordion-body">Puedes contactarnos a través de nuestro fourmulario de contacto o
                            por teléfono.</div>
                    </div>
                </div>
                <div class="accordion-item">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">El tiempo de entrega es de 24 horas a 36 horas hábiles, dependiendo
                            de tu ubicación.</div>
                    </div>
                </div>
                <div class="accordion-item">
...
<footer data-aos="fade-up" data-aos-duration="100" class="footer">
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    ...
                    <p class="company-description">Llevamos los productos más frescos del campo a tu mesa, garantizando
                        calidad y frescura en cada entrega.</p>
                ...
                <div class="footer-section">
                    ...
                    <div class="contact-info">
                        ...
                        <p><i class="fas fa-map-marker-alt"></i>
                            <a href="https://share.google/uCjgbp9lKkg6hyuRB" target="_blank" rel="noopener noreferrer">
                                Tv. 94 L #88-08, Bogotá</a>
                        </p>
