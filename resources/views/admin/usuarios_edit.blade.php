...
<div class="container mt-5">
    ...
    <form action="{{ route('usuario.update', $usuario->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="tipo_de_genero" class="form-control">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="pass_us" class="form-control" placeholder="Ingrese nueva contraseña">
        </div>

        <button type="submit" class="btn btn-success">Actualizar Usuario</button>
        <a href="{{ route('usuario.index') }}" class="btn btn-secondary ms-2">Volver</a>
    </form>
</div>
