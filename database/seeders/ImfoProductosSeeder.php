...
class ImfoProductosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('productos')->insert([
            ...
            // 🧀 Lácteos
            ['id' => 15, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 5, 'unidad_medida_id' => 3, 'nombre_producto' => 'Queso Campesino', 'stock' => 50, 'descripccion' => 'Queso fresco de leche entera', 'imagen' => 'Queso.png', 'precio_unitario' => 9000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 16, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 5, 'unidad_medida_id' => 4, 'nombre_producto' => 'Leche Entera', 'stock' => 120, 'descripccion' => 'Leche fresca pasteurizada', 'imagen' => 'Leche.jpg', 'precio_unitario' => 4000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 17, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 5, 'unidad_medida_id' => 4, 'nombre_producto' => 'Yogurt Natural', 'stock' => 90, 'descripccion' => 'Yogurt natural sin azúcar', 'imagen' => 'Yogurt.jpg', 'precio_unitario' => 3500, 'created_at' => $now, 'updated_at' => $now],

            // 🍞 Panadería
            ['id' => 18, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 6, 'unidad_medida_id' => 3, 'nombre_producto' => 'Pan Tajado', 'stock' => 140, 'descripccion' => 'Pan tajado blanco ideal para sándwiches', 'imagen' => 'Pan tajado.webp', 'precio_unitario' => 5000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 19, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 6, 'unidad_medida_id' => 3, 'nombre_producto' => 'Pan Francés', 'stock' => 200, 'descripccion' => 'Pan francés crocante', 'imagen' => 'Pan frances.png', 'precio_unitario' => 600, 'created_at' => $now, 'updated_at' => $now],

            // 🥤 Bebidas
            ['id' => 20, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 7, 'unidad_medida_id' => 4, 'nombre_producto' => 'Gaseosa Coca-Cola 1.5L', 'stock' => 100, 'descripccion' => 'Gaseosa refrescante', 'imagen' => 'CocaCola.webp', 'precio_unitario' => 5000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 21, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 7, 'unidad_medida_id' => 4, 'nombre_producto' => 'Agua Brisa 1.5L', 'stock' => 150, 'descripccion' => 'Agua mineral sin gas', 'imagen' => 'Agua.webp', 'precio_unitario' => 3000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 22, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 7, 'unidad_medida_id' => 4, 'nombre_producto' => 'Jugo Hit Mango 1L', 'stock' => 130, 'descripccion' => 'Jugo de mango pasteurizado', 'imagen' => 'Jugo.png', 'precio_unitario' => 4500, 'created_at' => $now, 'updated_at' => $now],

            // 🥚 Huevos
            ['id' => 23, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 8, 'unidad_medida_id' => 3, 'nombre_producto' => 'Huevo AA x30', 'stock' => 80, 'descripccion' => 'Huevo fresco categoría AA', 'imagen' => 'Huevo.png', 'precio_unitario' => 15000, 'created_at' => $now, 'updated_at' => $now],

            // 🧂 Abarrotes
            ['id' => 24, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 9, 'unidad_medida_id' => 1, 'nombre_producto' => 'Arroz xKg', 'stock' => 300, 'descripccion' => 'Arroz blanco premium', 'imagen' => 'Arroz.jpg', 'precio_unitario' => 3500, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 25, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 9, 'unidad_medida_id' => 1, 'nombre_producto' => 'Frijol Bola Roja xKg', 'stock' => 200, 'descripccion' => 'Frijol rojo ideal para sopas', 'imagen' => 'Frijol desgranado.png', 'precio_unitario' => 7000, 'created_at' => $now, 'updated_at' => $now],
        ]);
    }
}
