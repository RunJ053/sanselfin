...
class ImfoProductosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('productos')->insert([
            ...
            ['id' => 4, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 2, 'unidad_medida_id' => 1, 'nombre_producto' => 'Papa Pastusa', 'stock' => 400, 'descripccion' => 'Papa ideal para sopas y guisos', 'imagen' => 'Papa pastusa.png', 'precio_unitario' => 2000, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 5, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 2, 'unidad_medida_id' => 1, 'nombre_producto' => 'Zanahoria', 'stock' => 150, 'descripccion' => 'Zanahoria fresca, rica en vitaminas', 'imagen' => 'Zanahoria.png', 'precio_unitario' => 2500, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 7, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 2, 'unidad_medida_id' => 2, 'nombre_producto' => 'Perejil', 'stock' => 100, 'descripccion' => 'Perejil fresco en atado', 'imagen' => 'Perejil.png', 'precio_unitario' => 1200, 'created_at' => $now, 'updated_at' => $now],

            // 🍌 Frutas
            ['id' => 8, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 3, 'unidad_medida_id' => 1, 'nombre_producto' => 'Banano', 'stock' => 300, 'descripccion' => 'Banano maduro y fresco', 'imagen' => 'Banano.png', 'precio_unitario' => 2500, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 12, 'descuento_id' => 1, 'estado_id' => 1, 'categoria_id' => 3, 'unidad_medida_id' => 1, 'nombre_producto' => 'Manzana Roja', 'stock' => 200, 'descripccion' => 'Manzana fresca y crujiente', 'imagen' => 'Manzana.png', 'precio_unitario' => 7000, 'created_at' => $now, 'updated_at' => $now],
